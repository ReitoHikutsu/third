...
export const combinationBonuses = [
  ...
  { requiredIngredients:['dadacha','tofu','negi','shoyu'], name:'だだちゃ醤油の三拍子', points:10, reaction:'だだちゃ豆って鍋に入れるとどうなるかなと思ったけど……醤油と豆腐、ねぎが合わさると意外といいね！' },
  { requiredIngredients:['takuan','pork','negi','miso'], name:'たくあん味噌の逆転劇', points:9, reaction:'たくあんを鍋に入れるのは勇気がいるけど、味噌と豚肉がうまくまとめてくれてるね！' },
  { requiredIngredients:['hoshigaki','satoimo','tofu','miso'], name:'甘味噌干し柿芋煮', points:9, reaction:'干し柿を芋煮に！？……でも味噌と里芋が甘みをうまく受け止めてるね！' },
  { requiredIngredients:['pear','chicken','negi','salt'], name:'洋梨なのに塩鶏鍋', points:10, reaction:'ラ・フランスを鍋に入れるなんて大胆だね！でも塩味の鶏肉と合わせると……意外とアリ！' },
  { requiredIngredients:['cherry','tofu','maitake','salt'], name:'さくらんぼ狩り……鍋', points:10, reaction:'さくらんぼを鍋に入れるとは思わなかったよ！でも舞茸と豆腐に塩なら、意外とまとまってるね！' },
  { requiredIngredients:['corn','chicken','negi','shoyu'], name:'焼きとうもろこし鶏醤油', points:9, reaction:'とうもろこしの甘みに醤油、鶏肉とねぎ……これはちゃんと一つの料理になってる！' },
  { requiredIngredients:['wine','pork','maitake','miso'], name:'山形晩酌味噌鍋', points:10, reaction:'ワインを芋煮に！？と思ったけど、味噌と豚肉、舞茸が意外とうまくまとめてるね！' },
  { requiredIngredients:['chocolate','satoimo','beef','miso'], name:'禁断のチョコ味噌芋煮', points:12, reaction:'えっ、チョコレート！？……でも隠し味として味噌と牛肉に合わせると、コクが出てるかも！' },
  { requiredIngredients:['shrimp','dadacha','tofu','salt'], name:'だだちゃ海老の塩合わせ', points:9, reaction:'だだちゃ豆と海老って珍しい組み合わせだね！塩でまとめると、ちゃんと海鮮鍋っぽい！' },
  { requiredIngredients:['eel','takuan','satoimo','shoyu'], name:'山形ごちそう三重奏', points:11, reaction:'うなぎにたくあん！？と思ったけど、醤油と里芋が全体をまとめてくれてるね！' },
  { requiredIngredients:['chocolate','kimchi','eel'], name:'禁断の三角関係', points:-15, reaction:'チョコにキムチにうなぎ……みんな主張が強すぎるよ！？' },
  { requiredIngredients:['cherry','natto','pork'], name:'さくらんぼ納豆騒動', points:-12, reaction:'さくらんぼの甘酸っぱさに納豆と豚肉……これはちょっと事件だね……' },
  { requiredIngredients:['pear','takuan','beef'], name:'洋梨たくあん牛鍋', points:-10, reaction:'ラ・フランスとたくあんが牛肉の中で喧嘩してる……！' },
  { requiredIngredients:['hoshigaki','shrimp','konjac'], name:'海と山の迷子鍋', points:-9, reaction:'干し柿にエビにこんにゃく……どこを目指した鍋なのか分からなくなってきたよ！' },
  { requiredIngredients:['corn','eel','tofu'], name:'とうもろこしうなぎ豆腐', points:-8, reaction:'甘いとうもろこしにうなぎ……豆腐が間に挟まれて困ってるよ！' },
  { requiredIngredients:['wine','natto','chicken'], name:'発酵ワイン騒動', points:-11, reaction:'ワインと納豆と鶏肉……香りが三方向から押し寄せてくるよ！' },
  { requiredIngredients:['takuan','cheese','shrimp'], name:'たくあん海鮮チーズ', points:-10, reaction:'たくあんとチーズまでは分かるけど、そこにエビ……うーん、まとまらない！' },
  { requiredIngredients:['dadacha','chocolate','salmon'], name:'だだちゃショコラ鮭', points:-14, reaction:'だだちゃ豆にチョコ、そして鮭！？これは庵ちゃんでも救えないかも……！' },
  { requiredIngredients:['cherry','udon','kimchi'], name:'さくらんぼキムチうどん', points:-10, reaction:'うどんとキムチは分かる。でも、さくらんぼはどこから来たの！？' },
  { requiredIngredients:['pear','mochi','natto'], name:'洋梨納豆もち', points:-12, reaction:'甘い、粘る、もちもち……三つの個性が強すぎるよ！' },
